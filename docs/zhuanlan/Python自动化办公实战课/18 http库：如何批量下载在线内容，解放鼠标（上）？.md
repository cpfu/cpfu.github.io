...
截图左侧就是调试页面，截图的右侧是网页的内容，你可以通过截图左上角的"选择元素按钮"- ![](assets/a405f574a1814277b4fac67d4a4df24c.jpg)- 点击图片，左侧的调试界面会自动定位到图片对应的HTML代码。而你向上查找，会发现图片下方的""标签的"href"属性，就记录了图片ID和下载地址。
